...
\item
  ...
  \textbf{GDP in Case 1:} In aggregate, all \(L_1\) seniors will form
  ...
  L\_0,z\_0.\$ The first term is output from teams (which equals total
  ...
  We should note a \textbf{participation constraint}: seniors will only
  ...
  \(w_1 \ge z_1\) implies: \(\frac{z_1 - z_0}{\,h(1-z_0)\,} \ge z_1.\)
  This rearranges to \$ z\_1 ;\ge; \frac{z_0}{\,1 - h(1-z_0)\,},.
  \tag{PC}\$ This inequality is assumed to hold by parameter choice (the
  ...
  alone.
\item
  \textbf{Case 2: Juniors are the bottleneck (Junior-scarce, ``Too many
  ...
  factor. In equilibrium, junior wages will be bid \textbf{above} their
  ...
  (1-z\_0){]},. \tag{6}\$ This is the \textbf{junior's wage in Case 2}.
...
\item
  ...
  imagine \textbf{incentives for firms to hire and train juniors} even
  if AI is available, to sustain human capital formation.
\item
  \textbf{Evidence on AI's impact on training and skills:} Given that
  ...
  \item
    ...
    automation risk, \textbf{workers and firms invest less in training}.
    ...
    Muehlemann (2024) finds that \textbf{AI adoption in German firms led
    ...
    AI-centric way.
  \item
    There is anecdotal evidence of companies \textbf{reducing
    ...
    \emph{``why hire juniors when a single senior with AI can do the
  ...
  \item
    On the flip side, AI tools might serve as a \emph{training device}.
    The study by Brynjolfsson et al.~(2023) provides
    \textbf{``proof-of-concept'' that generative AI can supplement human
    ...
    These findings suggest a possible \emph{complementary} path: instead
  ...
  \end{itemize}
\item
  \textbf{Policy responses:} If indeed there is a danger that the
  pipeline of skill formation gets broken, what policies could mitigate
  this? One idea is \textbf{incentivizing human-complementary uses of
